...
const translations = {
  de: {
    ...
    // Legal Texts
    privacyText1: 'Easy Budget 2 respektiert Ihre Privatsphäre. Alle Ihre Finanzdaten werden ausschliesslich lokal auf Ihrem Gerät gespeichert. Wir sammeln, übertragen oder speichern keine persönlichen Daten auf externen Servern.',
    ...
    termsText1: 'Durch die Nutzung von Easy Budget 2 erklären Sie sich mit folgenden Bedingungen einverstanden:',
  ...
  en: {
    ...
    // Legal Texts
    privacyText1: 'Easy Budget 2 respects your privacy. All your financial data is stored exclusively locally on your device. We do not collect, transmit or store any personal data on external servers.',
    ...
    termsText1: 'By using Easy Budget 2, you agree to the following terms:',
  ...
  fr: {
    ...
    // Legal Texts
    privacyText1: 'Easy Budget 2 respecte votre vie privée. Toutes vos données financières sont stockées exclusivement localement sur votre appareil. Nous ne collectons, ne transmettons ni ne stockons aucune donnée personnelle sur des serveurs externes.',
    ...
    termsText1: 'En utilisant Easy Budget 2, vous acceptez les conditions suivantes:',
  ...
  es: {
    ...
    // Legal Texts
    privacyText1: 'Easy Budget 2 respeta su privacidad. Todos sus datos financieros se almacenan exclusivamente de forma local en su dispositivo. No recopilamos, transmitimos ni almacenamos ningún dato personal en servidores externos.',
    ...
    termsText1: 'Al usar Easy Budget 2, acepta los siguientes términos:',
  ...
  ru: {
    ...
    // Legal Texts
    privacyText1: 'Easy Budget 2 уважает вашу конфиденциальность. Все ваши финансовые данные хранятся исключительно локально на вашем устройстве. Мы не собираем, не передаём и не храним личные данные на внешних серверах.',
    ...
    termsText1: 'Используя Easy Budget 2, вы соглашаетесь со следующими условиями:',
